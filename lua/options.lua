...
api.nvim_set_keymap('v', '<m-j>', ":MoveBlock(1)<CR>", { noremap = true, silent = true })
api.nvim_set_keymap('n', '<m-k>', ":MoveLine(-1)<CR>", { noremap = true, silent = true })
api.nvim_set_keymap('v', '<m-k>', ":MoveBlock(-1)<CR>", { noremap = true, silent = true })
api.nvim_set_keymap('n', '<m-l>', ":MoveHChar(1)<CR>", { noremap = true, silent = true })
api.nvim_set_keymap('v', '<m-l>', ":MoveHBlock(1)<CR>", { noremap = true, silent = true })
